...
`paper-supplement-v1.0` exposes only papers, public derived artifacts, and
reproduction code.

## Canonical papers

1. [Provenance-Constrained Selective Language Style Planning from Sparse Evidence](paper/personavoice_preprint.pdf) - typed evidence, citation attribution, conflict preservation, selective abstention, and a measured calibration-transfer failure. Snapshot tag: `paper-language-v1.0`.
2. [PersonaVoice: One-Second Voice Cloning with Length-Adaptive Flow Matching](paper/personavoice_speech_preprint.pdf) - a 200-item one-second reference evaluation, protocol-matched baselines, ablations, and short-text catastrophic-failure analysis. Snapshot tag: `paper-speech-v1.0`.
...
See [`ZENODO.md`](ZENODO.md), [`CITATION.cff`](CITATION.cff), and
[`paper/README.md`](paper/README.md) for deposition metadata and paper build
instructions.
